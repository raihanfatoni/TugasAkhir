      ...
      <div class="sidebar-wrapper" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="<?= site_url('Home/Maps')?>">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url('Tanah/formpolygon')?>">
              <i class="material-icons">subject</i>
              <p>Form Polygon</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url('Tanah/formmarker')?>">
              <i class="material-icons">subject</i>
              <p>Form Marker</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url('Tanah/polygontanahwakaf')?>">
              <i class="material-icons">maps</i>
              <p>Polygon Tanah Wakaf</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url('Tanah/index')?>">
              <i class="material-icons">book</i>
              <p>Data Tanah Wakaf</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= site_url('Tanah/polygonsumedang')?>">
              <i class="material-icons">class</i>
              <p>Sebaran Tanah Wakaf</p>
            </a>
          </li>
        </ul>
      </div>
