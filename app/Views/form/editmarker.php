...
<form action=<?= base_url("/tanah/update") ?> method="post">
    <div class="box">
        ...
        <div><label>Input Manual Titik Marker: </label><input type="text" value= <?= $tanah->marker?> name="marker" class="form-control"></div>
        <input type="hidden" name="id" value="<?= $tanah->No; ?>">
        <input type="hidden" name="Lokasi" value="<?= $tanah->Lokasi; ?>">
        <input type="hidden" name="Tipe" value="<?= $tanah->Tipe; ?>">
        ...
        <input type="hidden" name="id_kecamatan" value="<?= $tanah->id_kecamatan; ?>">
        <input type="hidden" name="googleearth" value="<?= $tanah->googleearth; ?>">
        <textarea class="textarea" name="marker" placeholder =<?= $tanah->marker?> ></textarea>
        <br>
